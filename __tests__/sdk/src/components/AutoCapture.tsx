...
const AutoCapture = () => {
    ...
    return (<>
        <h3>Achor Tag</h3>
        <a id="anchor-test" name="anchor-test" target="_blank" onClick={() => navigate('/')}>Embedded Usermaven</a>
        ...
        <button id="button-test" name="button-test" className="um-no-capture">Simple button</button>
    </>)
}
